...
public class Product {
    ...
    public String toString() {
        ...
        return this.name + " , " + this.description + " , " + this.ID + " , " + Double.toString(this.cost);
    }
    ...
    public String readingCSVDataRecords(){
            ...
            File selectedFile;
            String rec = "";
            System.out.println("Please select a Product file...");
            ...
            try {
                ...
                if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                    ...
                    // we wrap a BufferedWriter around a lower level BufferedOutputStream
                    InputStream s =
                            new BufferedInputStream(Files.newInputStream(files, CREATE));
